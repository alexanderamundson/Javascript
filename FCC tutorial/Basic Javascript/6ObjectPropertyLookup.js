...
lookUpProfile("Akira", "likes");//should return "No such property"
lookUpProfile("Bob", "number");// should return "No such contact"
lookUpProfile("Harry","likes"); //should return an array

/*
We have an array of objects representing different
people in our contacts lists.
...
If name does not correspond to any contacts then return 
"No such contact"
